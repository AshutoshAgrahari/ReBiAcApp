...
theme_ReBiAcApp <- shinyDashboardThemeDIY(
  ...
  ### general
  appFontFamily = "Lucidatypewriter"
  ,appFontColor = "rgb(0, 147, 150)"
  ,primaryFontColor = "rgb(22, 134, 163)" #"rgb(0,0,0)"
  ,successFontColor = "rgb(149, 252, 106)"  #"rgb(0,0,0)"
  ,warningFontColor = "rgb(247, 211, 66)" #"rgb(0,0,0)"
  ,dangerFontColor = "rgb(242, 2, 2)" #rgb(0,0,0)"
